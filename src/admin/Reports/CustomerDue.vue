      ...
      <div class="card m-4 bg-white shadow rounded-lg">
        <div class="card-datatable p-4 table-responsive">
          <div class="md:flex block justify-between items-center mb-4">
            <h5 class="text-2xl text-blue-500 font-semibold">Customer Due</h5>
...
export default {
  ...
  data() {
    return {
      ...
      sortDirection: 'asc',
      records: [
        { customerName: 'Customer A', referenceNo: 'REF001', duePayment: 300, date: '2025-01-01' },
        { customerName: 'Customer B', referenceNo: 'REF002', duePayment: 150, date: '2025-01-02' },
        { customerName: 'Customer C', referenceNo: 'REF003', duePayment: 500, date: '2025-01-03' },
        { customerName: 'Customer D', referenceNo: 'REF004', duePayment: 250, date: '2025-01-04' },
        { customerName: 'Customer E', referenceNo: 'REF005', duePayment: 400, date: '2025-01-05' },
        { customerName: 'Customer F', referenceNo: 'REF006', duePayment: 600, date: '2025-01-06' },
        { customerName: 'Customer G', referenceNo: 'REF007', duePayment: 200, date: '2025-01-07' },
        { customerName: 'Customer H', referenceNo: 'REF008', duePayment: 300, date: '2025-01-08' },
        { customerName: 'Customer I', referenceNo: 'REF009', duePayment: 550, date: '2025-01-09' },
        { customerName: 'Customer J', referenceNo: 'REF010', duePayment: 700, date: '2025-01-10' },
        { customerName: 'Customer K', referenceNo: 'REF011', duePayment: 800, date: '2025-01-11' },
        { customerName: 'Customer L', referenceNo: 'REF012', duePayment: 900, date: '2025-01-12' }
      ]
    };
  },
  computed: {
  ...
  methods: {
    ...
    exportToPDF() {
      ...
      const headers = ['SN', 'Customer Name', 'Reference No', 'Due Payment'];
