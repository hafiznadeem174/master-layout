      ...
      <div class="card m-4 bg-white shadow rounded-lg">
        <div class="card-datatable p-4 table-responsive">
          <div class="md:flex block justify-between items-center mb-4">
            <h5 class="text-2xl text-blue-500 font-semibold">Supplier Ledger</h5>
...
export default {
  ...
  data() {
    return {
      ...
      sortDirection: 'asc',
      records: [
        { supplierName: 'Supplier A', referenceNo: 'REF001', grandTotal: 500, paid: 200, due: 300, date: '2025-01-01' },
        { supplierName: 'Supplier B', referenceNo: 'REF002', grandTotal: 700, paid: 500, due: 200, date: '2025-01-02' },
        { supplierName: 'Supplier C', referenceNo: 'REF003', grandTotal: 800, paid: 400, due: 400, date: '2025-01-03' },
        { supplierName: 'Supplier D', referenceNo: 'REF004', grandTotal: 600, paid: 300, due: 300, date: '2025-01-04' },
        { supplierName: 'Supplier E', referenceNo: 'REF005', grandTotal: 1000, paid: 600, due: 400, date: '2025-01-05' },
        { supplierName: 'Supplier F', referenceNo: 'REF006', grandTotal: 450, paid: 200, due: 250, date: '2025-01-06' },
        { supplierName: 'Supplier G', referenceNo: 'REF007', grandTotal: 900, paid: 450, due: 450, date: '2025-01-07' },
        { supplierName: 'Supplier H', referenceNo: 'REF008', grandTotal: 550, paid: 250, due: 300, date: '2025-01-08' },
        { supplierName: 'Supplier I', referenceNo: 'REF009', grandTotal: 1200, paid: 900, due: 300, date: '2025-01-09' },
        { supplierName: 'Supplier J', referenceNo: 'REF010', grandTotal: 1500, paid: 1100, due: 400, date: '2025-01-10' },
        { supplierName: 'Supplier K', referenceNo: 'REF011', grandTotal: 2000, paid: 1500, due: 500, date: '2025-01-11' },
        { supplierName: 'Supplier L', referenceNo: 'REF012', grandTotal: 2500, paid: 1800, due: 700, date: '2025-01-12' }
      ]
    };
  },
  computed: {
  ...
  methods: {
    ...
    exportToPDF() {
      ...
      const headers = ['SN', 'Supplier Name', 'Reference No', 'Grand Total', 'Paid', 'Due', 'Date'];
