      ...
      <div class="card m-4 bg-white shadow rounded-lg">
        <div class="card-datatable p-4 table-responsive">
          <div class="md:flex block justify-between items-center mb-4">
            <h5 class="text-2xl text-blue-500 font-semibold">Ingredient Units</h5>
...
export default {
  ...
  data() {
    return {
      ...
      sortDirection: 'asc',
      records: [
        { categoryName: "Burgers", description: "Cheeseburger with lettuce and tomato", addedBy: "Admin", createdAt: "2025-01-01", status: "Available" },
        { categoryName: "Burgers", description: "Classic Burger with pickles and onions", addedBy: "Admin", createdAt: "2025-01-02", status: "Unavailable" },
        { categoryName: "Fries", description: "Crispy French Fries", addedBy: "Admin", createdAt: "2025-01-03", status: "Available" },
        { categoryName: "Pizza", description: "Pepperoni Pizza with mozzarella", addedBy: "Admin", createdAt: "2025-01-04", status: "Available" },
        { categoryName: "Pizza", description: "Vegetarian Pizza with bell peppers and olives", addedBy: "Admin", createdAt: "2025-01-05", status: "Unavailable" },
        { categoryName: "Burgers", description: "Bacon Cheeseburger with special sauce", addedBy: "Admin", createdAt: "2025-01-06", status: "Available" },
        { categoryName: "Drinks", description: "Coca Cola - 500ml", addedBy: "Admin", createdAt: "2025-01-07", status: "Unavailable" },
        { categoryName: "Drinks", description: "Lemonade - Freshly squeezed", addedBy: "Admin", createdAt: "2025-01-08", status: "Unavailable" },
        { categoryName: "Fries", description: "Sweet Potato Fries", addedBy: "Admin", createdAt: "2025-01-09", status: "Available" },
        { categoryName: "Pizza", description: "BBQ Chicken Pizza", addedBy: "Admin", createdAt: "2025-01-10", status: "Available" },
        { categoryName: "Burgers", description: "Vegan Burger with plant-based patty", addedBy: "Admin", createdAt: "2025-01-11", status: "Unavailable" },
        { categoryName: "Pizza", description: "Margarita Pizza with fresh basil", addedBy: "Admin", createdAt: "2025-01-12", status: "Available" }
      ]
