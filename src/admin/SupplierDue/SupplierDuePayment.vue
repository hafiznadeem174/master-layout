      ...
      <div class="card m-4 bg-white shadow rounded-lg">
        <div class="card-datatable p-4 table-responsive">
          <div class="md:flex block justify-between items-center mb-4">
            <h5 class="text-2xl text-blue-500 font-semibold">Supplier Due Payments</h5>
          ...
          <div class="md:flex block justify-between items-center mb-4">
            ...
            <div class="mt-4 md:mt-0 flex items-center">
              ...
              <input
                ...
                placeholder="Search by Supplier, Note, or Payment"
              />
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      records: [
        { supplier: "Supplier A", amount: "₨ 3500.00", note: "Note for Supplier A", addedBy: "Jaffa'z", createdAt: "2025-01-01" },
        { supplier: "Supplier B", amount: "₨ 4500.50", note: "Note for Supplier B", addedBy: "Jaffa'z", createdAt: "2025-01-02" },
        { supplier: "Supplier C", amount: "₨ 2500.75", note: "Note for Supplier C", addedBy: "Jaffa'z", createdAt: "2025-01-03" },
        { supplier: "Supplier D", amount: "₨ 3200.00", note: "Note for Supplier D", addedBy: "Jaffa'z", createdAt: "2025-01-04" },
        { supplier: "Supplier E", amount: "₨ 5000.00", note: "Note for Supplier E", addedBy: "Jaffa'z", createdAt: "2025-01-05" },
        { supplier: "Supplier F", amount: "₨ 1800.50", note: "Note for Supplier F", addedBy: "Jaffa'z", createdAt: "2025-01-06" },
        { supplier: "Supplier G", amount: "₨ 1000.00", note: "Note for Supplier G", addedBy: "Jaffa'z", createdAt: "2025-01-07" },
        { supplier: "Supplier H", amount: "₨ 700.00", note: "Note for Supplier H", addedBy: "Jaffa'z", createdAt: "2025-01-08" },
        { supplier: "Supplier I", amount: "₨ 800.00", note: "Note for Supplier I", addedBy: "Jaffa'z", createdAt: "2025-01-09" },
        { supplier: "Supplier J", amount: "₨ 900.00", note: "Note for Supplier J", addedBy: "Jaffa'z", createdAt: "2025-01-10" },
        { supplier: "Supplier K", amount: "₨ 1100.00", note: "Note for Supplier K", addedBy: "Jaffa'z", createdAt: "2025-01-11" },
        { supplier: "Supplier L", amount: "₨ 1200.00", note: "Note for Supplier L", addedBy: "Jaffa'z", createdAt: "2025-01-12" },
        { supplier: "Supplier M", amount: "₨ 1300.00", note: "Note for Supplier M", addedBy: "Jaffa'z", createdAt: "2025-01-13" },
        { supplier: "Supplier N", amount: "₨ 1400.00", note: "Note for Supplier N", addedBy: "Jaffa'z", createdAt: "2025-01-14" },
        { supplier: "Supplier O", amount: "₨ 1500.00", note: "Note for Supplier O", addedBy: "Jaffa'z", createdAt: "2025-01-15" },
      ],
      sortColumn: null,
      sortOrder: 'asc',
    };
  ...
  computed: {
    filteredRecords() {
      ...
      return filteredData.slice(0, 15); // Limit to 15 records
    }
  },
  methods: {
    sortTable(column) {
    ...
    exportToPDF() {
      const doc = new jsPDF();
      doc.setFontSize(18);
      doc.text('Supplier Due Payments', 20, 20);
      doc.setFontSize(12);
      const headers = ['SN', 'Supplier', 'Amount', 'Note', 'Added By', 'Created At'];
      ...
      doc.save('supplier_due_payments.pdf');
    }
  },
};
</script>
